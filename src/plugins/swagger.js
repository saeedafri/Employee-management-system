...
const r409 = { description: 'Conflict — duplicate, cycle, or resource already exists' };
const r422 = { description: 'Validation Error — field-level validation failure; error.details[] contains {field, message} pairs' };
const r500 = { description: 'Internal Server Error' };
