...
const canManagePayouts = requirePermission('payout:manage');
const canManageBankSchemas = requirePermission('payroll:super');
const canReadOwnPayouts = requirePermission('payout:self');
...
export default async function payoutRoutes(fastify) {
  ...
  fastify.get('/payroll/country-bank-schemas', {
    ...
    onRequest: [authenticate, canManageBankSchemas],
  }, ctrl.listCatalog);
  ...
  fastify.get('/payroll/me/payout-methods', {
    ...
    onRequest: [authenticate, canReadOwnPayouts],
  }, ctrl.listMine);
  ...
  fastify.get('/payroll/payout-methods/approvals', {
    ...
    onRequest: [authenticate, canManagePayouts],
  }, ctrl.listApprovals);
