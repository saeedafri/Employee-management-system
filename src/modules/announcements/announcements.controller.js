...
export async function updateAnnouncement(request, reply) {
  try {
    const ann = await service.updateAnnouncement(request.tenant.id, request.params.id, request.body || {});
...
export async function deleteAnnouncement(request, reply) {
  try {
    const result = await service.deleteAnnouncement(request.tenant.id, request.params.id);
