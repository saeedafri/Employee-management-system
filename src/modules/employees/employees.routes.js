...
export async function employeesRoutes(fastify) {
  ...
  fastify.post(
    '/employees',
    {
      ...
      preValidation: [requirePermission('employees:write')],
    },
    createEmployee,
  );
  ...
  fastify.patch(
    '/employees/:id',
    {
      ...
      onRequest: [requirePermission('employees:write')],
    },
    updateEmployee,
  );
  ...
  fastify.delete(
    '/employees/:id',
    {
      ...
      onRequest: [requirePermission('employees:delete')],
    },
    deleteEmployee,
  );
  ...
  fastify.get(
    '/employees/export/csv',
    {
      ...
      onRequest: [requirePermission('employees:export')],
    },
    exportEmployees,
  );
