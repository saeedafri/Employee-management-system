...
export default async function settingsRoutes(fastify) {
  ...
  fastify.get('/settings/integrations/storage', { schema: { tags: ['Settings'], description: 'Storage integration status (Cloudinary + Postgres metadata)', security: [{ Bearer: [] }], response: { 200: obj } }, onRequest: adminOnly }, (req, rep) => settingsController.getStorageIntegration(req, rep));
