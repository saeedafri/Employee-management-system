# SA-GAP-MENUS — SUPER_ADMIN Gap-Menus Confirm Deep E2E
...
- **Why:** Download event failure: {}
- **Classification:** FRONTEND
- **How to resolve:** Ensure export triggers a real file download with Content-Disposition
- **Screenshot:** `docs/e2e-ui-screenshots/confirm/sa-gap-menus/n/a`
